import { Injectable, NgZone, Pipe, Inject, PLATFORM_ID, NgModule, Component, Input, Output, EventEmitter, ViewChild, ChangeDetectionStrategy, Injector, ViewEncapsulation, defineInjectable, inject } from '@angular/core';
